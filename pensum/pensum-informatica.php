...
class PDF_MC_Table extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(0,10,'PENSUM DE ESTUDIO (2022)',0,1,'C');
        $this->Cell(0,10,'ID DE CARRERA: 3 - INGENIERIA EN INFORMATICA',0,1,'C');
        $this->Ln(5);
    }
...
$sql = "SELECT semestre, cod_asignatura, nombre_asignatura, horas_teoricas, horas_practicas, horas_semanales, UC, prelaciones  FROM pensum_informatica ORDER BY semestre, cod_asignatura";
$result = $conn->query($sql);

// Verificar si se obtuvieron resultados
if ($result->num_rows > 0) {
    // Definir anchos de columna
    $pdf->SetWidths(array(15, 50, 20, 20, 20, 20, 50));
