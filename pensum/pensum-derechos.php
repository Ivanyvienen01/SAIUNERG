...
class PDF_MC_Table extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(0,10,'ID DE CARRERA: 6 - DERECHOS',0,1,'C');
        $this->Ln(5);
    }
...
$sql = "SELECT año, cod_asignatura, nombre_asignatura, horas_teoricas, horas_practicas, horas_semanales, UC, prelaciones  FROM pensum_derechos ORDER BY año, cod_asignatura";
    ...
    while ($row = $result->fetch_assoc()) {
        if ($previous_semester != $row['año']) {
            if ($previous_semester != '') {
                $pdf->Ln(32); // Agregar una fila para separar los años
            }
