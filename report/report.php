...
if ($result->num_rows > 0) {
    ...
    $pdf->SetWidths(array(10, 30, 40, 20, 65, 30, 30, 30, 25));
    ...
    $pdf->HeaderRow(array('#', 'NOMBRES', 'APELLIDOS', 'CEDULA', 'CORREO', 'CARRERA', 'INGRESO', 'FECHA INSCRIP.', 'ESTADO / USUARIO'));
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $data = array($numero_ascendente, $row["nombres"], $row["apellidos"], $row["cedula"], $row["correo"], $row["nombre_carrera"], $row["tipo_ingreso"], $row["fecha_inscripcion"], 'Inactivo');
        $pdf->Row($data);
    }
} else {
