...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    $sql = "SELECT * FROM preinscripciones_rechazadas WHERE nombres LIKE '%$search%' OR apellidos LIKE '%$search%' OR cedula LIKE '%$search%' OR correo LIKE '%$search%' OR nombre_carrera LIKE '%$search%' OR fecha_inscripcion LIKE '%$search%' OR fecha_rechazo LIKE '%$search%' OR tipo_ingreso LIKE '%$search%'";
} else {
