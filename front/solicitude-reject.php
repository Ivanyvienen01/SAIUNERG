        ...
        <div class="container-fluid d-flex justify-content-start ">
            ...
            <div class="col-12">
                ...
                <div class="col-sm-auto">
                    <h1 class="mb-3">Solicitudes de Preinscripcion Rechazadas</h1>
                </div>
                ...
                <div class="col-md-12">
                    <div class="d-flex justify-content-start mb-2">
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light ">
                            ...
                            <a href="../report/report-reject.php" class="btn btn-primary me-2">Generar Reporte</a>
                            <a href="../report/report-reject-daily.php" class="btn btn-primary me-2">Generar Reporte Diario</a>
                        ...
                        $sql = "SELECT * FROM preinscripciones_rechazadas";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>" . htmlspecialchars($row["fecha_rechazo"]) . "</td>";
                    ...
                    <script>
                        $(document).ready(function() {
                            ...
                            $('#searchInput').on('input', function() {
                                ...
                                $.ajax({
                                    type: 'GET',
                                    url: '../back/search-reject.php', // Archivo PHP que maneja la búsqueda
